...
pub(crate) struct FirefoxHistory {
...
pub(crate) struct History {
    pub(crate) moz_places_id: i64,
    pub(crate) url: String,   // Can be null
    pub(crate) title: String, // Can be null
    pub(crate) rev_host: String,
    pub(crate) visit_count: i64,
    pub(crate) hidden: i64,
    pub(crate) typed: i64,
    pub(crate) frequency: i64,
    pub(crate) last_visit_date: i64, // Can be null
    pub(crate) guid: String,
    pub(crate) foreign_count: i64, // Can be null
    pub(crate) url_hash: i64,
    pub(crate) description: String,       // Can be null
    pub(crate) preview_image_url: String, // Can be null
...
impl FirefoxHistory {
    ...
    pub(crate) fn get_history() -> Result<Vec<FirefoxHistory>, FirefoxHistoryError> {
    ...
    pub(crate) fn history_query(path: &str) -> Result<Vec<History>, FirefoxHistoryError> {
            ...
            Ok(history_iter) => {
                ...
                for history in history_iter {
                    match history {
                        ...
                        Err(err) => {
                            warn!(
                                "[firefox] Failed to iterate through Firefox history data: {err:?}"
                            );
                        }
                    }
                }
...
mod tests {
    ...
    fn test_history_query() {
        ...
        let history = FirefoxHistory::history_query(test_path).unwrap();
