...
fn js_stat(path: String) -> Result<JsFileInfo, AnyError> {
...
mod tests {
    ...
    #[cfg(target_os = "macos")]
    fn test_js_stat_mac() {
        let test = "";
    ...
    fn test_js_stat_windows() {
        let test = "";
        let mut output = output_options("runtime_test", "local", "./tmp", false);
        let script = JSScript {
            name: String::from("stat_path"),
            script: test.to_string(),
    ...
    fn test_js_stat_linux() {
        let test = "";
        let mut output = output_options("runtime_test", "local", "./tmp", false);
        let script = JSScript {
            name: String::from("stat_path"),
            script: test.to_string(),
