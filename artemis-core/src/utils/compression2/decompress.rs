use super::{
    ...
    xpress::{
        api::decompress_huffman_api, huffman::decompress_xpress_huffman, lz77::decompress_lz77,
        lznt::decompress_lznt,
    },
};
...
pub(crate) fn decompress_xpress(
    ...
    match format {
        ...
        XpressType::Api => {
            decompress_huffman_api(data, &mut decompress_data, format, decompress_size)?
        }
        XpressType::Default => {
...
mod tests {
    use crate::{
        ...
        utils::compression2::decompress::{decompress_xpress, XpressType},
    };
