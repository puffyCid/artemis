...
mod tests {
    ...
    fn test_acquire_bad_file() {
        ...
        let out = output_options("acquire_file", "local", "./tmp", false, 0, String::from("ewogICAgImJ1Y2tldCI6ICJibGFoIiwKICAgICJzZWNyZXQiOiAicGtsNkFpQWFrL2JQcEdPenlGVW9DTC96SW1hSEoyTzVtR3ZzVWxSTCIsCiAgICAia2V5IjogIkFLSUEyT0dZQkFINlRPSUFVSk1SIiwKICAgICJyZWdpb24iOiAidXMtZWFzdC0yIgp9"));
    ...
    fn test_acquire_file_gcp() {
        ...
        let out = output_options("acquire_file", "gcp", "./tmp", false, port, String::from(""));
    ...
    fn test_acquire_file_aws() {
        ...
        let out = output_options("acquire_file", "aws", "./tmp", false, port, String::from("ewogICAgImJ1Y2tldCI6ICJibGFoIiwKICAgICJzZWNyZXQiOiAicGtsNkFpQWFrL2JQcEdPenlGVW9DTC96SW1hSEoyTzVtR3ZzVWxSTCIsCiAgICAia2V5IjogIkFLSUEyT0dZQkFINlRPSUFVSk1SIiwKICAgICJyZWdpb24iOiAidXMtZWFzdC0yIgp9"));
