...
mod tests {
    ...
    fn test_parse_custom() {
        ...
        assert_eq!(result[0].lnk_info.accessed, "2023-08-06T23:53:22.705Z");
        ...
        assert_eq!(result[7].lnk_info.created, "2019-10-21T05:48:39.785Z");
        assert_eq!(result[7].lnk_info.modified, "2023-06-14T13:21:20.000Z");
        assert_eq!(result[7].lnk_info.accessed, "2023-08-06T23:53:22.705Z");
