...
pub(crate) fn js_memory(
    ...
    let results = serde_json::to_value(&mem).unwrap_or_default();
...
mod tests {
    use crate::{
        runtime::run::execute_script, structs::artifacts::runtime::script::JSScript,
        structs::toml::Output,
    };
